/*
 * @Author: zhaosigui
 * @Date: 2024-02-04 11:57:41
 * @LastEditors: zhaosigui
 * @LastEditTime: 2024-02-04 13:00:46
 * @FilePath: \antd\zntd\src\components\AutoComplete\autoComplete.test.tsx
 * @Description: 
 */
...
describe('test AutoComplete component', () => {
  ...
  it('test basic AutoComplete behavior', async () => {
    ...
    // expect(screen.querySelectorAll('.suggestion-item').length).toEqual(2)
